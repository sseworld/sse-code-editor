...
let RenameInputField = class RenameInputField {
    ...
    getDomNode() {
        if (!this._domNode) {
            ...
            this._disposables.add(this._input.onDidChange(() => {
                ...
                (_c = this._renameCandidateListView) === null || _c === void 0 ? void 0 : _c.clearFocus();
            }));
    ...
    getInput(where, currentName, selectionStart, selectionEnd, supportPreview, candidates, cts) {
        this._isEditingRenameCandidate = false;
