...
define(["require", "exports", "./sse.contribution", "./lib/lib.index", "../../fillers/sse-editor-core"], function (require, exports, sse_contribution_1, lib_index_1, sse_editor_core_1) {
    "use strict";
    ...
    var LibFiles = /** @class */ (function () {
        ...
        LibFiles.prototype.getOrCreateModel = function (fileName) {
            var uri = sse_editor_core_1.Uri.parse(fileName);
            var model = sse_editor_core_1.editor.getModel(uri);
            if (model) {
                return model;
            }
            if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
                return sse_editor_core_1.editor.createModel(this._libFiles[uri.path.slice(1)], 'typescript', uri);
            }
            var matchedLibFile = sse_contribution_1.typescriptDefaults.getExtraLibs()[fileName];
            if (matchedLibFile) {
                return sse_editor_core_1.editor.createModel(matchedLibFile.content, 'typescript', uri);
            }
            return null;
        };
    ...
    var DiagnosticsAdapter = /** @class */ (function (_super) {
        ...
        function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
                ...
                var visibleSubscription = model.onDidChangeAttached(function () {
                    ...
                    if (onlyVisible) {
                        if (model.isAttachedToEditor()) {
                            ...
                            sse_editor_core_1.editor.setModelMarkers(model, _this._selector, []);
                        }
                    }
                });
            ...
            _this._disposables.push(sse_editor_core_1.editor.onDidCreateModel(function (model) { return onModelAdd(model); }));
            _this._disposables.push(sse_editor_core_1.editor.onWillDisposeModel(onModelRemoved));
            _this._disposables.push(sse_editor_core_1.editor.onDidChangeModelLanguage(function (event) {
                onModelRemoved(event.model);
                onModelAdd(event.model);
            }));
            _this._disposables.push({
                dispose: function () {
                    for (var _i = 0, _a = sse_editor_core_1.editor.getModels(); _i < _a.length; _i++) {
                        var model = _a[_i];
            ...
            sse_editor_core_1.editor.getModels().forEach(function (model) { return onModelAdd(model); });
            return _this;
        }
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            relatedUris = diagnostics
                                ...
                                return relatedInformation.file ? sse_editor_core_1.Uri.parse(relatedInformation.file.fileName) : null;
                            });
                        ...
                        case 3:
                            ...
                            sse_editor_core_1.editor.setModelMarkers(model, this._selector, diagnostics.map(function (d) { return _this._convertDiagnostics(model, d); }));
                            return [2 /*return*/];
                    }
                });
            });
        ...
        DiagnosticsAdapter.prototype._convertDiagnostics = function (model, diag) {
            ...
            if (diag.reportsUnnecessary) {
                tags.push(sse_editor_core_1.MarkerTag.Unnecessary);
            }
            if (diag.reportsDeprecated) {
                tags.push(sse_editor_core_1.MarkerTag.Deprecated);
            }
            return {
        ...
        DiagnosticsAdapter.prototype._tsDiagnosticCategoryToMarkerSeverity = function (category) {
            switch (category) {
                case DiagnosticCategory.Error:
                    return sse_editor_core_1.MarkerSeverity.Error;
                case DiagnosticCategory.Message:
                    return sse_editor_core_1.MarkerSeverity.Info;
                case DiagnosticCategory.Warning:
                    return sse_editor_core_1.MarkerSeverity.Warning;
                case DiagnosticCategory.Suggestion:
                    return sse_editor_core_1.MarkerSeverity.Hint;
            }
            return sse_editor_core_1.MarkerSeverity.Info;
        };
    ...
    var SuggestAdapter = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            wordRange = new sse_editor_core_1.Range(position.lineNumber, wordInfo.startColumn, position.lineNumber, wordInfo.endColumn);
                            resource = model.uri;
                        ...
                        case 2:
                            ...
                            suggestions = info.entries.map(function (entry) {
                                ...
                                if (entry.replacementSpan) {
                                    ...
                                    range = new sse_editor_core_1.Range(p1.lineNumber, p1.column, p2.lineNumber, p2.column);
                                }
                                var tags = [];
                                if (entry.kindModifiers !== undefined && entry.kindModifiers.indexOf('deprecated') !== -1) {
                                    tags.push(sse_editor_core_1.languages.CompletionItemTag.Deprecated);
                                }
                                return {
                                    uri: resource,
                                    position: position,
        ...
        SuggestAdapter.convertKind = function (kind) {
            switch (kind) {
                ...
                case Kind.keyword:
                    return sse_editor_core_1.languages.CompletionItemKind.Keyword;
                case Kind.variable:
                case Kind.localVariable:
                    return sse_editor_core_1.languages.CompletionItemKind.Variable;
                case Kind.memberVariable:
                case Kind.memberGetAccessor:
                case Kind.memberSetAccessor:
                    return sse_editor_core_1.languages.CompletionItemKind.Field;
                case Kind.function:
                case Kind.memberFunction:
                case Kind.constructSignature:
                case Kind.callSignature:
                case Kind.indexSignature:
                    return sse_editor_core_1.languages.CompletionItemKind.Function;
                case Kind.enum:
                    return sse_editor_core_1.languages.CompletionItemKind.Enum;
                case Kind.module:
                    return sse_editor_core_1.languages.CompletionItemKind.Module;
                case Kind.class:
                    return sse_editor_core_1.languages.CompletionItemKind.Class;
                case Kind.interface:
                    return sse_editor_core_1.languages.CompletionItemKind.Interface;
                case Kind.warning:
                    return sse_editor_core_1.languages.CompletionItemKind.File;
            }
            return sse_editor_core_1.languages.CompletionItemKind.Property;
        };
    ...
    var SignatureHelpAdapter = /** @class */ (function (_super) {
        ...
        SignatureHelpAdapter._toSignatureHelpTriggerReason = function (context) {
            switch (context.triggerKind) {
                case sse_editor_core_1.languages.SignatureHelpTriggerKind.TriggerCharacter:
                ...
                case sse_editor_core_1.languages.SignatureHelpTriggerKind.ContentChange:
                    return context.isRetrigger ? { kind: 'retrigger' } : { kind: 'invoked' };
                case sse_editor_core_1.languages.SignatureHelpTriggerKind.Invoke:
                default:
                    return { kind: 'invoked' };
            }
        };
                                    ...
                                    return entry.highlightSpans.map(function (highlightSpans) {
                                        return {
                                            ...
                                            kind: highlightSpans.kind === 'writtenReference'
                                                ? sse_editor_core_1.languages.DocumentHighlightKind.Write
                                                : sse_editor_core_1.languages.DocumentHighlightKind.Text
                                        };
                                    });
                                })];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this._libFiles.fetchLibFilesIfNecessary(entries.map(function (entry) { return sse_editor_core_1.Uri.parse(entry.fileName); }))];
                        case 3:
                            // Fetch lib files if necessary
                            _a.sent();
                            if (model.isDisposed()) {
                        ...
                        case 2:
                            ...
                            convert = function (item, containerLabel) {
                                ...
                                var result = {
                                    name: item.text,
                                    detail: '',
                                    kind: (outlineTypeTable[item.kind] || sse_editor_core_1.languages.SymbolKind.Variable),
    ...
    outlineTypeTable[Kind.module] = sse_editor_core_1.languages.SymbolKind.Module;
    outlineTypeTable[Kind.class] = sse_editor_core_1.languages.SymbolKind.Class;
    outlineTypeTable[Kind.enum] = sse_editor_core_1.languages.SymbolKind.Enum;
    outlineTypeTable[Kind.interface] = sse_editor_core_1.languages.SymbolKind.Interface;
    outlineTypeTable[Kind.memberFunction] = sse_editor_core_1.languages.SymbolKind.Method;
    outlineTypeTable[Kind.memberVariable] = sse_editor_core_1.languages.SymbolKind.Property;
    outlineTypeTable[Kind.memberGetAccessor] = sse_editor_core_1.languages.SymbolKind.Property;
    outlineTypeTable[Kind.memberSetAccessor] = sse_editor_core_1.languages.SymbolKind.Property;
    outlineTypeTable[Kind.variable] = sse_editor_core_1.languages.SymbolKind.Variable;
    outlineTypeTable[Kind.const] = sse_editor_core_1.languages.SymbolKind.Variable;
    outlineTypeTable[Kind.localVariable] = sse_editor_core_1.languages.SymbolKind.Variable;
    outlineTypeTable[Kind.variable] = sse_editor_core_1.languages.SymbolKind.Variable;
    outlineTypeTable[Kind.function] = sse_editor_core_1.languages.SymbolKind.Function;
    outlineTypeTable[Kind.localFunction] = sse_editor_core_1.languages.SymbolKind.Function;
    // --- formatting ----
    ...
    var InlayHintsAdapter = /** @class */ (function (_super) {
        ...
        InlayHintsAdapter.prototype._convertHintKind = function (kind) {
            switch (kind) {
                case 'Parameter':
                    return sse_editor_core_1.languages.InlayHintKind.Parameter;
                case 'Type':
                    return sse_editor_core_1.languages.InlayHintKind.Type;
                default:
                    return sse_editor_core_1.languages.InlayHintKind.Type;
            }
        };
