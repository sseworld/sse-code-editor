 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "./lib/typescriptServicesMetadata", "../../fillers/sse-editor-core"], function (require, exports, typescriptServicesMetadata_1, sse_editor_core_1) {
    "use strict";
    ...
    var LanguageServiceDefaultsImpl = /** @class */ (function () {
        function LanguageServiceDefaultsImpl(compilerOptions, diagnosticsOptions, workerOptions, inlayHintsOptions, modeConfiguration) {
            ...
            this._onDidExtraLibsChange = new sse_editor_core_1.Emitter();
    ...
    exports.typescriptDefaults = new LanguageServiceDefaultsImpl({ allowNonTsExtensions: true, target: ScriptTarget.Latest }, {
        noSemanticValidation: false,
        noSyntaxValidation: false,
        onlyVisible: false
    }, {}, {}, modeConfigurationDefault);
    exports.javascriptDefaults = new LanguageServiceDefaultsImpl({ allowNonTsExtensions: true, allowJs: true, target: ScriptTarget.Latest }, {
    ...
    sse_editor_core_1.languages.typescript = {
    ...
    sse_editor_core_1.languages.onLanguage('typescript', function () {
        return getMode().then(function (mode) { return mode.setupTypeScript(exports.typescriptDefaults); });
    });
    sse_editor_core_1.languages.onLanguage('javascript', function () {
