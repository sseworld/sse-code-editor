...
define(["require", "exports", "../../fillers/sse-editor-core"], function (require, exports, sse_editor_core_1) {
    ...
    sse_editor_core_1.languages.css = { cssDefaults: exports.cssDefaults, lessDefaults: exports.lessDefaults, scssDefaults: exports.scssDefaults };
    function getMode() {
        if (AMD) {
    ...
    sse_editor_core_1.languages.onLanguage('less', function () {
        getMode().then(function (mode) { return mode.setupMode(exports.lessDefaults); });
    });
    sse_editor_core_1.languages.onLanguage('scss', function () {
        getMode().then(function (mode) { return mode.setupMode(exports.scssDefaults); });
    });
    sse_editor_core_1.languages.onLanguage('css', function () {
