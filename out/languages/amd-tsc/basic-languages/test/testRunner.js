...
define(["require", "exports", "../_.contribution", "assert", "../../fillers/sse-editor-core", "../monaco.contribution"], function (require, exports, __contribution_1, assert, sse_editor_core_1) {
    "use strict";
    ...
    function runTest(languageId, test) {
        ...
        var actualTokens = sse_editor_core_1.editor.tokenize(text, languageId);
