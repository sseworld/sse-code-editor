 ...
 *-----------------------------------------------------------------------------*/
define("vs/language/typescript/sse.contribution", ["require","vs/editor/editor.api"],(require)=>{
"use strict";
var moduleExports = (() => {
  ...
  var LanguageServiceDefaultsImpl = class {
    constructor(compilerOptions, diagnosticsOptions, workerOptions, inlayHintsOptions, modeConfiguration) {
      ...
      this._onDidExtraLibsChange = new sse_editor_core_exports.Emitter();
  ...
  sse_editor_core_exports.languages.typescript = {
    ModuleKind,
    JsxEmit,
    NewLineKind,
    ScriptTarget,
  ...
  sse_editor_core_exports.languages.onLanguage("typescript", () => {
    return getMode().then((mode) => mode.setupTypeScript(typescriptDefaults));
  });
  sse_editor_core_exports.languages.onLanguage("javascript", () => {
