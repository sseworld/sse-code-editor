...
export interface Settings {
	...
	customConfig: JsonString<ISSESetup>;
...
export function toLoaderConfig(settings: Settings): ISSESetup {
	switch (settings.monacoSource) {
		...
		case "npm":
			...
			return {
				...getSSESetup(`${url}/${settings.npmStability}/vs`),
		...
		case "independent":
			...
			const setup = { ...getSSESetup(coreUrl) };
			if (
