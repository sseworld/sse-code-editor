...
// import { loadSSE } from "../../../monaco-loader";
...
} from "../../components/sse/SSEEditor";
import { ObservablePromise } from "../../utils/ObservablePromise";
import React = require("react");
import { ref } from "../../utils/ref";
import { sseEditorVersion } from "../../sseEditorVersion";
			...
			<Page>
				<div className="container py-4">
					...
					<div className="px-5 mb-0">
						<h3>Download v{sseEditorVersion}</h3>
						<div className="row">
							<div className="span12">
								<br />
								<p>
									The latest released version is{" "}
									<strong>{sseEditorVersion}</strong>.
								</p>
								<p>
									Download with this direct{" "}
									<a
										target="_blank"
										href={`https://registry.npmjs.org/monaco-editor/-/monaco-editor-${sseEditorVersion}.tgz`}
									>
										download link
									</a>{" "}
									or{" "}
